...
class D2D_Subprogram:
    ...
    def E3631xA_Out_ON(self):
        ...
        for i in range(3):
            ...
            if str(Output_Status) == '+1\n':
                ...
                print('Error : Channel' + str(i + 1) + ' is in CC (constant current) operating mode')
    ...
    def E3631xA_Setup(self,CH1_V,CH2_V,CH3_V,CH1_A,CH2_A,CH3_A,**kargs):
        ...
        for i in range(3) :
            ...
            E3631xA.write("VOLT:MODE FIX,(@"+ str(i+1)+ ");:VOLT "+ str(V_list[i])+ ",(@"+ str(i+1)+");")
            E3631xA.write("CURR:MODE FIX,(@"+ str(i+1)+ ");:CURR "+ str(A_list[i])+ ",(@"+ str(i+1)+");")
            E3631xA.write(":OUTP ON,(@"+ str(i+1)+")")
            time.sleep(0.5)
            Output_Status = E3631xA.query("STAT:QUES:INST:ISUM"+ str(i+1) +":COND?")
            # print(Output_Status)
    ...
    def E36233A_setup(self,CH1_V,CH2_V,CH1_A,CH2_A,**kargs):
        ...
        for i in range(2) :
            ...
            E36233A.write("VOLT:MODE FIX,(@"+ str(i+1)+ ");:VOLT "+ str(V_list[i])+ ",(@"+ str(i+1)+");")
            E36233A.write("CURR:MODE FIX,(@"+ str(i+1)+ ");:CURR "+ str(A_list[i])+ ",(@"+ str(i+1)+");")
    ...
    def E36233A_setup_one_channel(self,CH_V,CH_A,CH_Select, **kargs):
        ...
        rm = pyvisa.ResourceManager()
        E36233A = rm.open_resource(visa)
        E36233A.write("VOLT:MODE FIX,(@"+ str(CH_Select)+ ");:VOLT "+ str(CH_V)+ ",(@"+ str(CH_Select)+");")
        E36233A.write("CURR:MODE FIX,(@"+ str(CH_Select)+ ");:CURR "+ str(CH_A)+ ",(@"+ str(CH_Select)+");")
        ...
        if str(Output_Status) == '+1\n':
            ...
            print('Error : Channel'+ str(CH_Select) + ' is in CC (constant current) operating mode')
        elif str(Output_Status) == '+3\n':
            E36233A.write(":OUTP OFF,(@" + str(CH_Select) + ")")
    ...
    def E3631xA_Read_V(self):
        ...
        for i in range(3): # read power supply 3 channel
            rm = pyvisa.ResourceManager()
            E3631xA = rm.open_resource(visa)
            CURR_val = E3631xA.query(":MEAS:VOLT? (@"+ str(i+1)+")") # Read meter voltage value command
            CURR_val_log += [float(CURR_val)]
        CH1_CURR = str(CURR_val_log[0])
        CH2_CURR = str(CURR_val_log[1])
    ...
    def E3631xA_Read_V_ch1(self):
        ...
        E3631xA = rm.open_resource( 'USB0::0x2A8D::0x3302::MY59001241::0::INSTR' ) # instument visa address
        CURR_val = E3631xA.query(":MEAS:VOLT? (@1") # Read power supply channel1 voltage value command
    def E36000A_setup_channel(self, **kargs):
        ...
        E36233A.write("VOLT:MODE FIX,(@"+ ch_select + ");:VOLT "+ ch_volt + ",(@"+ ch_select +");")
        E36233A.write("CURR:MODE FIX,(@"+ ch_select + ");:CURR "+ ch_amp + ",(@"+ ch_select +");")
        ...
        if str(Output_Status) == '+1\n':
            ...
            print('Error : Channel'+ ch_select + ' is in CC (constant current) operating mode')
        elif str(Output_Status) == '+3\n':
            E36233A.write(":OUTP OFF,(@" + ch_select + ")")
    ...
    def TA5000_Temp_read(self, value, **kargs):
        ...
        while True:
            ...
            Temp = float(TA5000.query("Temp?"))
            if sense == 1:
                self.gui.run_0.Voltage_Sense(no_rst=1, no_tx_rst=1, xls_ToolsEven_3=self.gui.ToolsEven_3)
    ...
    def Meter_R_Current(self,**kargs):
        rm = pyvisa.ResourceManager()
        visa_list = (self.gui.K_34411A_4_visa.Value,self.gui.K_34461A_2_visa.Value,self.gui.K_34461A_1_visa.Value)
        for i in range(3):
    ...
    def Keysight_DataLog_793(self, **kargs):
        ...
        result = 'NA'
        result_list = []
        chan_array = ['101','102','103','104','105','106','107','108','109','110','111','112','113','114','115','116','117','118','119','120']
    ...
    def PG_81160A_2CH(self, **kargs):
        ...
        PG_81160A.write(':FUNC1 SQU;:VOLT1 ' + str(0.9) + ';:VOLT1:OFFS 0.000000;:FREQ1 ' + str(50000000) + ';')
        PG_81160A.write(':FUNC2 SQU;:VOLT2 ' + str(0.9) + ';:VOLT2:OFFS 0.000000;:FREQ2 ' + str(CMU_S) + ';')
        PG_81160A.write(':OUTPut1:IMPedance:EXTernal 50;:OUTput1 ON;:OUTPut1:COMPlement ON;')
        PG_81160A.write(':OUTPut2:IMPedance:EXTernal 50;:OUTput2 ON;:OUTPut2:COMPlement ON;')
    ...
    def xls_write_result_vco(self, excel_path, sheet_name, Hyperlink_path, **kargs):
        ...
        Excel_Path = load_workbook(filename=excel_path)
        Select_sheet = Excel_Path[sheet_name]
        for vco_result in [Die0_4s_V, Die1_4s_V, Die2_4s_V, Die3_4s_V, Die0_8s_H, Die1_8s_H, Die2_8s_H, Die3_8s_H]:
    ...
    def DataLog_E3631xA_sense(self, **kargs):
        ...
        Power_setup = (str(self.gui.E3631xA_CH1_V.Value) + ',' + str(self.gui.E3631xA_CH2_V.Value) + ',' + str(self.gui.E3631xA_CH3_V.Value))
        ...
        if S_CH_V[0] < min_sense_v or S_CH_V[1] < min_sense_v or S_CH_V[2] < min_sense_v:
            print(f'\033Sense too small V1:{S_CH_V[0]}, V2:{S_CH_V[1]} or V3:{S_CH_V[2]} < {min_sense_v}')
    ...
    def DPO72504C_Save_png(self,**kargs):
        ...
        Save_png_command = "EXPort:FILEName 'C:\\Test Waveform\\" + File_name + ".png';:EXPort STAR"
